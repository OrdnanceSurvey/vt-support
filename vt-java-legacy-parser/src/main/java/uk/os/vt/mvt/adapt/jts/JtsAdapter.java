...
import uk.os.vt.mvt.encoding.MvtUtil;
...
public final class JtsAdapter {
   ...
   * <p>Uses the same tile and clipping coordinates. May cause rendering issues on boundaries for
   * polygons or line geometry depending on styling.</p>
   *
   * @param geometry       original 'source' geometry
   ...
   * @see TileGeomResult
   */
  public static TileGeomResult createTileGeom(Geometry geometry,
                                              Envelope tileEnvelope,
                                              GeometryFactory geomFactory,
                                              MvtLayerParams mvtLayerParams,
                                              IGeometryFilter filter) {
    return createTileGeom(flatFeatureList(geometry), tileEnvelope, geomFactory,
  ...
  public static TileGeomResult createTileGeom(List<Geometry> geometryList,
                                              ...
                                              MvtLayerParams mvtLayerParams,
                                              IGeometryFilter filter) {
    return createTileGeom(geometryList, tileEnvelope, tileEnvelope, geomFactory, mvtLayerParams,
        filter);
  }
   ...
   *
   * @param geom       flat geometry via {@link #flatFeatureList(Geometry)} that can be translated
   *                   to a feature
  ...
  /**
   * <p>Convert a {@link Point} or {@link MultiPoint} geometry to a list of MVT geometry drawing
   * commands. See
   * <a href="https://github.com/mapbox/vector-tile-spec">vector-tile-spec</a>
   * for details.</p>
   * <p>WARNING: The value of the {@code cursor} parameter is modified as a result of calling this
   * method.</p>
   *
   * @param geom   input of type {@link Point} or {@link MultiPoint}. Type is NOT checked and
   ...
   * A {@link MultiLineString} or {@link MultiPolygon} can be encoded by calling this method
   * multiple times.</p>
   * <p>See <a href="https://github.com/mapbox/vector-tile-spec">vector-tile-spec</a>
   * for details.</p>
   * <p>WARNING: The value of the {@code cursor} parameter is modified as a result of calling this
   * method.</p>
   *
   * @param geom         input of type {@link LineString} or {@link Polygon}. Type is NOT checked
   *                     and expected to be correct.
  ...
  /**
   * <p>Count number of coordinates starting from the end of the coordinate array backwards that
   * match the first coordinate value.</p>
  ...
  /**
   * <p>Appends {@link ZigZag#encode(int)} of delta in x,y from {@code cursor} to {@code mvtPos}
   * into the {@code geomCmds} buffer.</p>
  ...
  /**
   * Return true if the values of the two {@link Coordinate} are equal when their first and second
   * ordinates are cast as ints. Ignores 3rd ordinate.
   *
